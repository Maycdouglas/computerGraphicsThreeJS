...
let lightBasic = initDefaultBasicLight(scene); // Create a basic light to illuminate the scene

lightPosition = new THREE.Vector3(4,2.5,4);
...
var groundPlane = createGroundPlane(10, 10, 50, 50); // width and height
...
let cylinderGeometry = new THREE.CylinderGeometry(0.125, 1, 3, 24)
//let cylinderMaterial = new THREE.MeshLambertMaterial({color:"lightblue"})
